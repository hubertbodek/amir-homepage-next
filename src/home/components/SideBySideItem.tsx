...
export default function SideBySideItem({
  ...
  return (
    <div
      className={`grid grid-cols-1 items-center md:grid-cols-12 gap-x-8 min-h-[240px] text-left ${styles.text}`}
    >
      <div className={`${styles.textContainer}`}>
        <h3 className="text-5xl mb-4 text-neutral-100 font-bold">{title}</h3>
        <p className="text-2xl mb-4 font-light text-neutral-300">{description}</p>
        <Button theme="secondary" href={learnMoreUrl} arrow>
          Dowiedz sie wiecej
        </Button>
      </div>
      <div className={`${styles.imageContainer} h-[668px] relative`}>
