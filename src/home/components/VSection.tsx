  ...
  return (
    <section className="relative bg-gradient-to-b from-light to-neutral-200 pb-24 overflow-x-clip">
      <div className="absolute w-full h-28 mx-auto md:top-8 left-0 flex items-center justify-center">
        <h3 className="max-w-md text-2xl md:text-4xl text-center mx-auto absolute z-10 uppercase font-bold tracking-wider">
      ...
      <div className="text-primary amir-container grid grid-cols-1 md:grid-cols-2 mt-20 pb-12 md:divide-x divide-tertiary/80">
        <div className="md:pr-16 mb-8">
          <h4 className="text-h4 font-bold mb-2">
            Lorem ipsum dolor sit amet.
          </h4>
          <p className="mb-4">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea enim
            quos aliquam voluptatum ipsa similique aperiam adipisci assumenda
            ratione a.
          </p>
          <h4 className="text-h4 font-bold mb-2">
            Lorem ipsum dolor sit amet.
      ...
      <Image
        src="/images/decorations/bryla3.png"
        alt="Dekoracje"
        className="hidden lg:block absolute -top-16 -left-48"
        height="400"
        width="400"
      />
      <Image
        src="/images/decorations/bryla3.png"
        alt="Dekoracje"
        className="hidden lg:block absolute -top-16 -right-48"
        height="400"
        width="400"
      />
    </section>
