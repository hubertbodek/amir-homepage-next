const styles = {
  ...
  filled:
    'text-xl px-4 py-2 border border-secondary bg-gradient-to-r from-primary to-secondary transition-[background-size] ease-out duration-200 bg-no-repeat bg-[length:0%_100%] hover:bg-[length:100%_100%]',
} as const
